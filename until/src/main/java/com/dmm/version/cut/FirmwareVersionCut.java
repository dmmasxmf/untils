...
public class FirmwareVersionCut {
    ...
    public static boolean versionJudge2(String oldVersion,String newVersion){

        String[] oldVersionS=oldVersion.split("^(.)*[V|v]")[1].split("\\.");

        String[] newVersionS=newVersion.split("^(.)*[V|v]")[1].split("\\.");
